...
public class PostArtReq {
    ...
    public PostArtReq(String title, String simpleDescription, Integer price, String exclusive, Integer additionalCharge, Integer amount, List<String> copyright, String description, List<String> filetype, String category, List<String> tags) throws Exception {
        this.title = title;
